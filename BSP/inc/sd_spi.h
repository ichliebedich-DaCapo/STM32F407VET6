#ifndef FURINA_SD_SPI_H
#define FURINA_SD_SPI_H
...
#define SD_START_DATA_SINGLE_BLOCK_READ    0xFE //Data token start byte, 单块读起始Token
#define SD_START_DATA_MULTIPLE_BLOCK_READ  0xFE //Data token start byte, 多块读起始Token
#define SD_START_DATA_SINGLE_BLOCK_WRITE   0xFE //Data token start byte, 单块写起始Token
#define SD_START_DATA_MULTIPLE_BLOCK_WRITE 0xFC //Data token start byte, 多块写起始Token
#define SD_STOP_DATA_MULTIPLE_BLOCK_WRITE  0xFD //Data toke stop byte  , 多块写停止Token
