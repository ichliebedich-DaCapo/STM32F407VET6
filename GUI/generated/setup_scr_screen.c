...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->screen_label_tracks, &lv_font_arial_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_tracks, 196, 301);
    lv_obj_set_size(ui->screen_btn_tracks, 90, 18);
    ...
    lv_obj_set_style_text_font(ui->screen_btn_tracks, &lv_font_SourceHanSerifSC_Regular_12, LV_PART_MAIN|LV_STATE_DEFAULT);
