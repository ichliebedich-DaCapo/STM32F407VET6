...
/**
 * \brief A variable to specify UI icon resource id from RC file on Windows platform
 */
 ...
 *  generate UI events.
 *
 * When UI events are Component by controller input, the app will be
 ...
 *
 *  On QtWayland platforms, windows are rotated client-side to allow for UI
