...
# Include UI path of lv_conf_ext.h which may be Component in gui-guider
if(EXISTS ${LVGL_ROOT_DIR}/../custom/lv_conf_ext.h)
  target_include_directories(lvgl SYSTEM PUBLIC ${LVGL_ROOT_DIR}/../custom)
endif()
