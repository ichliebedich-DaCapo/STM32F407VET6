...
/**
 * Register a new, UI event ID.
 * It can be used the same way as e.g. `LV_EVENT_CLICKED` to send UI events
 ...
 * @param           user_data UI data data will be available in `event_cb`
