...
namespace gui::init
{
    void screen() 
    {
		...
		scale_screen_scale_1.init()
			...
			.line_color(lv_color_hex(0x757575), static_cast<int>(LV_PART_ITEMS)|static_cast<int>(LV_STATE_DEFAULT))
			...
			.line_color(lv_color_hex(0x757575), static_cast<int>(LV_PART_INDICATOR)|static_cast<int>(LV_STATE_DEFAULT))
